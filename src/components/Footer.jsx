...
function Footer() {
  ...
  useGSAP(() => {
    gsap.from(logo.current, {
      scrollTrigger: {
        ...
        end: "top 30%", // Adjust end position
        scrub: 1, // Smooth effect
      },
      y: "-100%", // Move logo upwards initially
  ...
  return (
    <footer ref={main} className="w-full sm:h-[100vh] h-[85vh] text-white px-5">
      <div className="flex w-full h-full ">
        <div className="top  w-full h-full   flex flex-col justify-between">
          <div className="w-full sm:py-10 sm:px-7 flex justify-between">
            <div className="links leading-[1.5]  flex flex-col  text-3xl mt-5">
              <a href="">Home</a>
              <a href="">Work</a>
              <a href="">About</a>
              <a href="">Service</a>
            ...
            <div className="flex  flex-col justify-between text- w-1/2 mt-5">
              <div className="flex  flex-col">
                <a href="">Instagram</a>
                <a href="">LinkedIn</a>
                <p>New Business:</p>
                <a href="hello@rejouice.com">hello@rejouice.com</a>
              </div>
              <p className="mt-5">&copy; 2023 Rejouice. All rights reserved.</p>
            </div>
          </div>
          <div className="w-full sm:px-7 ">
            <p>
              Sign up for our news latter <br /> (no spam){" "}
            </p>
            <input
              type="text"
              placeholder="Email"
              className="bg-transparent w-full py-5 border-b-2"
            />
            <div className="logo sm:my-5 overflow-y-hidden py-10">
              <svg
              ref={logo}
                id="Calque_1"
